...
const utilsembed = new Discord.MessageEmbed()
	...
	.addFields(
		...
		{
			name: "Soon",
			value: "avatar, ID, nick history, number of ppl in channel, member count, time in other zones, dictionnary, translate, currency, polls",
		}
	);
...
const modsembed = new Discord.MessageEmbed()
	...
	.addFields(
		{
			name: "mod",
			value: "Check wheter or not you have the mod role, and adds it if you want",
		},
		{
			name: "Soon",
			value: "mute/unmute, ban, kick, timed mute, player info(date joined, nb of msgs sent, nb of warnings), lock/unlock channel, slowmode on/off",
		}
	);
...
const musicembed = new Discord.MessageEmbed()
	...
	.addFields({
		name: "Soon",
		value: "Fully complete music bot via youtube, with search per words, queue system, pause, play, stop, skip, remove song fromm queue, add Dj roles, etc",
	});
...
const mcembed = new Discord.MessageEmbed()
	...
	.addFields({
		name: "Soon",
		value: "recipe dictionnary, mobs infos, general knowledege, who is online on a server atm, get skins/UUID/alts names, get 9b joindate, coords logger",
	});
...
const sotembed = new Discord.MessageEmbed()
	...
	.addFields({
		name: "Soon",
		value: "Fishes dictionnary, tall tales journal locations, patches notes, random knowledge trivia, map, storm locator, fleet creator integration",
	});
...
const twitchembed = new Discord.MessageEmbed()
	...
	.addFields({
		name: "Soon",
		value: "username verifier, live or not, shout out, roles, clips call, gen channel stats",
	});
...
const otherembed = new Discord.MessageEmbed()
	...
	.addFields({
		name: "Soon",
		value: "any other commands like quizzes, info on the bot, version, etc",
	});
